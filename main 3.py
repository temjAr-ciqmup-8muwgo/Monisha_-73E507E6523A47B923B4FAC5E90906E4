"""Implement a class BankAccount that represent a bank account.The class should have private
...
class BankAccount:
  ...
  def __int__(self ,acount_number,account_holder_name,initial_balance =0.0):
...
# self .__account_balance = self .__accont_balance+amount
...
# Create an instance of the BankAccount clas
account = BankAccount(account_number="123456789",
      account_holder_name="HariPrabu",
